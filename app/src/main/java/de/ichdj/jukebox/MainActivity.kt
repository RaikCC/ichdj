...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Entsperrt das Veranstaltermenü mit der Gerätesperre (PIN/Muster/
     * Fingerabdruck). Ungesicherte Geräte kommen direkt hinein.
     */
    private fun promptOperatorUnlock() {
        ...
        // Pinning kurz aufheben, sonst kann der Keyguard-Dialog unterdrückt werden
        kiosk.unpin()
